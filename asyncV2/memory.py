...
async def get_channel_messages(chat_id, msg_id):
    ...
    # api_hash = '565dc0ac75361b1141610ddff56c5a16's
    ...
    session_hash = os.environ['session_hash']
                ...
                if x.text != "":
                    if x.text is not None:
                        try:
                            ...
                            replied = x.reply_to
                            # The code stores the following information for each message in a dictionary:
                            # message id, date, user id of the sender, the message content, id of the message
                            # it was replied to, and if the message was pinned.
