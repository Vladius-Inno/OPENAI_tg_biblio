...
⚡️Я бот, рекомендующий книги и поддерживающий ChatGPT 3.5.turbo

Я умею:
    
1. Рекомендовать книги на основе ваших предпочтений - зайдите в Рекомендации
2. Вместе с ChatGPT:
    - Писать и редактировать тексты
    - Переводить с и на разные языки
    - Обобщать информацию
    - Поддерживать беседу и запоминать контекст - просто напишите мне, что вы хотите узнать, сделать или отредактировать.

Моя экспертность - в сфере литературы, её можно включить, выбрав режим Литературного эксперта. Также советую посетить раздел Рекомендаций
...
Спасибо! '''
    ...
    В режиме Рекомендаций вам будут демонстрироваться книги, которые вы можете оценивать. На основе ваших предпочтений для вас будут рассчитываться рекомендации.
